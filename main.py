...
async def main_async():
    ...
    print("\n Welcome to Pedigree Agent")
    print("\n Hi there! I'm here to help you fill out the pedigree form. Let's start with the proband, that is, the patient. Could you please provide some information about them?\n")
